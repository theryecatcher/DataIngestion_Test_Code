...
public class WebSocketConfig implements EnvironmentAware
{
    ...
    /**
	 * @return the predixTsWebSocketURI
	 */
	...
	/**
	 * @param predixTsWebSocketURI the predixTsWebSocketURI to set
	 */
	public void setPredixTsWebSocketURI(String predixTsWebSocketURI) {
		this.predixTsWebSocketURI = predixTsWebSocketURI;
	}

	@Override
	public void setEnvironment(Environment env) {
		this.predixTsWebSocketURI = env.getProperty("predixTsWebSocketURI");
